...
Without metadata: Looking at occurence of taxa across the combined environmental data. Bar plot depicts relative frequency across samples before filtering with metadata.
...
With metadata: Looking at the occurence of taxa across the combined evironmental data. Bar plot depicts relative freqeuency across samples after filtering with metadata. 
